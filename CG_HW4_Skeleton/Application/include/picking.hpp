...
inline void pickingInitialize(int frameBufferWidth, int frameBufferHeight, int unit) {
...
inline void reallocatePickingTexture(int frameBufferWidth, int frameBufferHeight, int unit) {
